...
type PlayerFilterResolver interface {
	PositionStrictMatch(ctx context.Context, obj *model.PlayerFilter, data *bool) error

	PositionLooseMatch(ctx context.Context, obj *model.PlayerFilter, data *bool) error
}
...
func (ec *executionContext) unmarshalInputGameFilter(ctx context.Context, obj interface{}) (model.GameFilter, error) {
	...
	fieldsInOrder := [...]string{"teamID", "opponentID", "opponentMatch", "playerID", "gameID", "seasons", "startDate", "endDate", "lastX", "gameType", "gameTypeMatch", "homeOrAway", "homeOrAwayMatch", "statFilters"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputModelInput(ctx context.Context, obj interface{}) (model.ModelInput, error) {
	...
	fieldsInOrder := [...]string{"model", "gameBreakdowns", "similarPlayerInput"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputPlayerFilter(ctx context.Context, obj interface{}) (model.PlayerFilter, error) {
	...
	fieldsInOrder := [...]string{"name", "playerID", "seasons", "positionStrict", "positionStrictMatch", "positionLoose", "positionLooseMatch", "teamABR", "teamID", "startDate", "endDate", "statFilters", "withPropositions"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
		...
		case "positionStrictMatch":
			...
			if err = ec.resolvers.PlayerFilter().PositionStrictMatch(ctx, &it, data); err != nil {
				return it, err
			}
		case "positionLoose":
			var err error
		...
		case "positionLooseMatch":
			...
			if err = ec.resolvers.PlayerFilter().PositionLooseMatch(ctx, &it, data); err != nil {
				return it, err
			}
		case "teamABR":
			var err error
...
func (ec *executionContext) unmarshalInputSimilarTeamInput(ctx context.Context, obj interface{}) (model.SimilarTeamInput, error) {
	...
	for _, k := range fieldsInOrder {
		...
		case "statsOfInterest":
			...
			ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("statsOfInterest"))
			it.StatsOfInterest, err = ec.unmarshalOStatFilter2ᚕᚖgithubᚗcomᚋzvandehyᚋDataTrainᚋnba_graphqlᚋgraphᚋmodelᚐStatFilterᚄ(ctx, v)
			if err != nil {
				return it, err
			}
		}
